...
from train_distill import args, model, device, run_model
...
class MyProblem(Problem):
    def __init__(self, supernet, teacher_net):
        self.supernet = supernet
        self.obj_functions = [
            partial(valid, loader=get_loader(), teacher_net=teacher_net),
            flops
        ]
...
if __name__ == "__main__":
    ...
    torch.save(res.pop, "saved-pops/distill_pop.pkl")
